...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (contactForm) {
    // Action 1: Standard Submit form (Email Simulator)
    contactForm.addEventListener('submit', (e) => {
      ...
      // Open standard mailto link immediately on the user-triggered thread to prevent browser pop-up blockers
      const mailtoBody = encodeURIComponent(`Name: ${name}\nEmail: ${email}\n\nMessage:\n${message}`);
      window.location.href = `mailto:aayushak0812@gmail.com?subject=${encodeURIComponent(subject)}&body=${mailtoBody}`;
      
      showFormFeedback(`Thank you, ${name}! Opening your email client to send message...`, 'success');
      contactForm.reset();
    });
